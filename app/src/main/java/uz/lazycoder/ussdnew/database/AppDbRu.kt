...
abstract class AppDbRu : RoomDatabase() {
    ...
    companion object {
        private var instance: AppDbRu? = null

        @Synchronized
        fun getInstance(context: Context): AppDbRu {
            if (instance == null) {
                instance =
                    Room.databaseBuilder(context, AppDbRu::class.java, "new_ussd_ru_db")
